...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="?module=control_calidad">Control calidad</a></li>
</ol><br><hr>
<h1>
    <i class="fa fa-folder icon-title"></i>Datos de Control calidad
    <a class="btn btn-primary btn-social pull-right" href="?module=form_control_calidad&form=add" title="Agregar" data-toggle="tooltip">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <section class="content-header">
                        ...
                        <form id="printForm" action="modules/control_calidad/print.php" method="GET" target="_blank" class="form-inline pull-right">
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               ?>                                          
                                ...
                                class="btn btn-danger btn-sm" href="modules/control_calidad/proses.php?act=anular&id=<?php echo $data['id_control_calidad'];?>">
                                ...
                                href="modules/control_calidad/print.php?act=imprimir&id_control_calidad=<?php echo $data['id_control_calidad']; ?>" target="_blank">
