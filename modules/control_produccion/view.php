...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="?module=control_produccion">Control producción</a></li>
</ol><br><hr>
<h1>
    <i class="fa fa-folder icon-title"></i>Datos de Control producción
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <section class="content-header">
                        ...
                        <form id="printForm" action="modules/control_produccion/print.php" method="GET" target="_blank" class="form-inline pull-right">
                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        <h2>Lista de Control de producción</h2>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               ?>                                          
                                ...
                                class="btn btn-danger btn-sm" href="modules/control_produccion/proses.php?act=anular&id=<?php echo $data['id_control_produccion'];?>">
                                ...
                                href="modules/control_produccion/print.php?act=imprimir&id_control_produccion=<?php echo $data['id_control_produccion']; ?>" target="_blank">
