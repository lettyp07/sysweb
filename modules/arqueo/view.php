...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="?module=arqueo">Arqueo</a></li>
</ol><br><hr>
<h1>
    <i class="fa fa-folder icon-title"></i>Datos de Arqueo
    <a class="btn btn-primary btn-social pull-right" href="?module=form_arqueo&form=add" title="Agregar" data-toggle="tooltip">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <section class="content-header">
                        ...
                        <form id="printForm" action="modules/arqueo/print.php" method="GET" target="_blank" class="form-inline pull-right">
                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <?php 
                            $nro=1;
                            $query = mysqli_query($mysqli, "SELECT a.*,u.username, s.sucursal 
                               FROM arqueo a
                               JOIN usuarios u
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               if ($data['estado']=='PENDIENTE') { ?>
                                ...
                                class="btn btn-success btn-sm" href="modules/arqueo/proses.php?act=on&id=<?php echo $data['id_arqueo'];?>">
                                ...
                                class="btn btn-danger btn-sm" href="modules/arqueo/proses.php?act=off&id=<?php echo $data['id_arqueo'];?>">
                                ...
                                href="modules/arqueo/print.php?act=imprimir&id_arqueo=<?php echo $data['id_arqueo']; ?>" target="_blank">
