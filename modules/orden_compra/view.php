        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <section class="content-header">
                        ...
                        <form id="printForm" action="modules/orden_compra/print.php" method="GET" target="_blank" class="form-inline pull-right">
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               if ($data['estado']=='activo') { ?>
                                ...
                                class="btn btn-primary btn-sm" href="modules/orden_compra/proses.php?act=update&id_orden=<?php echo $data['id_orden']; ?>" target="_blank">
                               ...
                               <a data-toggle="tooltip" data-placement="top" title="Anular" class="btn btn-danger btn-sm"
                                href="modules/orden_compra/proses.php?act=anular&id_orden=<?php echo $data['id_orden']; ?>"
                                onclick ="return confirm('Estás seguro/a de anular <?php echo $data['id_orden']; ?>?');">
                                ...
                                href="modules/orden_compra/print.php?act=imprimir&id_orden=<?php echo $data['id_orden']; ?>" target="_blank">
