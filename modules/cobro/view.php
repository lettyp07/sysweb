            ...
            ?>
                ...
                <div class="box-body">
                    <section class="content-header">
                        ...
                        <form id="printForm" action="modules/compras/print.php" method="GET" target="_blank" class="form-inline pull-right">
                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($mysqli, "SELECT
                                ...
                                FROM compra p 
                                JOIN proveedor pro 
                                ON pro.cod_proveedor =  p.cod_proveedor 
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               <a data-toggle="tooltip" data-placement="top" title="Anular" class="btn btn-danger btn-sm"
                                ...
                                onclick ="return confirm('Estás seguro/a de anular <?php echo $data['cod_compra']; ?>?');">
