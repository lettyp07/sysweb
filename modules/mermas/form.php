...
if ($_GET['form'] == 'add') { ?>
    <section class="content-header">
        <h1>
            <i class="fa fa-edit icon-title">Agregar Mermas</i>
        </h1>
        <ol class="breadcrumb">
            <li><a href="?module=start"><i class="fa fa-home"></i>Inicio</a></li>
            <li><a href="?module=mermas"> Mermas</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/mermas/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            //Método para generar código
                            $query_id = mysqli_query($mysqli, "SELECT MAX(id_merma) as id FROM mermas")
                            ...
                            <div class="form-group">
                            <label class="col-sm-2 control-label">Control calidad:</label>
                            <div class="col-sm-5">
                                <select class="form-control" name="codigo_control" id="codigo_control" required>
                                ...
                                JOIN orden_produccion op ON c.id_orden_produccion = op.id_orden_produccion
                                JOIN pedido_cliente pc ON op.id_pedido_cliente = pc.id_pedido_cliente
                                JOIN clientes cli ON pc.id_cliente = cli.id_cliente
                                WHERE EXISTS (
                                    SELECT 1
                                    FROM detalle_control_calidad dcc
                                    WHERE dcc.id_control_calidad = c.id_control_calidad
                                      AND dcc.estandar = 'Malo'
                                )                                
                                ");
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <input type="submit" class="btn btn-primary btn-submit" name="Guardar"
                                            value="Guardar">
                                        <a href="?module=mermas" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function load(page) {
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url: './ajax/productos_pedido5.php',
            data: parametros,
