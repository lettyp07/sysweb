...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="?module=mermas">Mermas</a></li>
</ol><br><hr>
<h1>
    <i class="fa fa-folder icon-title"></i>Mermas
    <a class="btn btn-primary btn-social pull-right" href="?module=form_mermas&form=add" title="Agregar" data-toggle="tooltip">
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <section class="content-header">
                        ...
                        <form id="printForm" action="modules/mermas/print.php" method="GET" target="_blank" class="form-inline pull-right">
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               { ?>
                                ...
                                href="modules/mermas/print.php?act=imprimir&id_merma=<?php echo $data['id_merma']; ?>" target="_blank">
                                    <i style="color:#000" class="fa fa-print"></i>
                                </a>
                                <a data-toggle="tooltip" data-placement="top" title="Anular" class="btn btn-danger btn-sm"
                                href="modules/mermas/proses.php?act=anular&id_merma=<?php echo $data['id_merma']; ?>"
                                onclick ="return confirm('Estás seguro/a de anular <?php echo $data['id_merma']; ?>?');">
