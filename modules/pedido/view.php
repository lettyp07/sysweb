                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               if ($data['estado']=='activo') { ?>
                                ...
                                class="btn btn-primary btn-sm" href="modules/pedido/proses.php?act=update&id_pedido=<?php echo $data['id_pedido']; ?>" target="_blank">
                               ...
                               <a data-toggle="tooltip" data-placement="top" title="Anular" class="btn btn-danger btn-sm"
                                href="modules/pedido/proses.php?act=anular&id_pedido=<?php echo $data['id_pedido']; ?>"
