...
if ($_GET['form'] == 'add') { ?>
    <section class="content-header">
        <h1>
            <i class="fa fa-edit icon-title">Agregar Ingrediente</i>
        </h1>
        <ol class="breadcrumb">
            <li><a href="?module=start"><i class="fa fa-home"></i>Inicio</a></li>
            <li><a href="?module=ajuste_stock">Ingredientes</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/ajuste_stock/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            //Método para generar código
                            $query_id = mysqli_query($mysqli, "SELECT MAX(id_ajuste) as id FROM ajuste_stock")
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tipo ajuste</label>
                                <div class="col-sm-2">
                                    <select type="text" class="form-control" name="tipo_ajuste"
                                        autocomplete="off" required id="tipo_ajuste">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <input type="submit" class="btn btn-primary btn-submit" name="Guardar"
                                            value="Guardar">
                                        <a href="?module=ajuste_stock" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function load(page) {
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url: './ajax/productos_ajuste_stock.php',
            data: parametros,
