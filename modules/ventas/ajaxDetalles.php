...
<table class="table table-bordered table-striped table-hover">
    ...
    //Insertar detalle de venta
            $sql = mysqli_query($mysqli, "DELETE FROM tmpp"
                    . "WHERE  tmpp.session_id = '" . session_id() . "'");
        $suma_total=0;
        ...
        CASE
            ...
            ELSE 0
        END AS iva10
    FROM detalle_pedido_cliente dc
    ...
    ");
        ...
        while($row=mysqli_fetch_array($sql)){
            ...
            $insert_tmp = mysqli_query($mysqli, "INSERT INTO "
                    . "`tmpp`(`id_producto`, `cantidad_tmp`, `session_id`, precio_tmp) "
                    . "VALUES (".$row['cod_producto'].", ".$row['cantidad'].", "
            ...
            <tr>
                ...
                <td><span class="pull-right"><a href="#" onclick="eliminar('<?php echo $row['cod_producto']; ?>')"><i class="glyphicon glyphicon-trash"></i></a></span></td>
            </tr>
    ...
    ?>
            ...
            <input type="text" name="total_venta" hidden id="total_venta" value='<?=$total_general?>'>
            </tfoot>
</table>