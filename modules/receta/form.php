...
if ($_GET['form'] == 'add') { ?>
    <section class="content-header">
        <h1>
            <i class="fa fa-edit icon-title">Agregar Receta</i>
        </h1>
        <ol class="breadcrumb">
            <li><a href="?module=start"><i class="fa fa-home"></i>Inicio</a></li>
            <li><a href="?module=receta"> Receta de pizzas</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/receta/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            //Método para generar código
                            $query_id = mysqli_query($mysqli, "SELECT MAX(id_receta) as id FROM receta")
                        ...
                        <input type="text" name="fecha" hidden value="<?php echo $fechaActual; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="chosen-select" name="id_producto"
                                        data-placeholder="Selecciona producto" autocomplete="off" required>
                                        <option value=""></option>
                                        <?php
                                        $query_prov = mysqli_query($mysqli, "SELECT p.id_producto, p.descrip, u.u_descrip
                                        FROM producto p
                                        ...
                                        while ($data_prov = mysqli_fetch_assoc($query_prov)) {
                                            echo "<option value=\"$data_prov[id_producto]\">$data_prov[descrip]-$data_prov[u_descrip]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <input type="submit" class="btn btn-primary btn-submit" name="Guardar"
                                            value="Guardar">
                                        <a href="?module=receta" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
